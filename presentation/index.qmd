...
format:
  revealjs: 
    ...
    footer: <https://github.com/pharmaverse/cicdworkshop.rinpharma2022>
...
::: {.incremental}
- Use Template from [CI/CD Workshop at R/Pharma conference 2022](https://github.com/pharmaverse/cicdworkshop.rinpharma2022)
- Clone into your RStudio Session and switch to `dev` branch
- Install `{devtools}`
- Use `devtools::install_dev_deps()` to get all necessary packages
...
- One Test
- One Vignette
- One Man Page/Function Documentation
- One 
