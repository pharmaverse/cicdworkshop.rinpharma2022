...
1. Links & URLs &nbsp; &nbsp;`r fontawesome::fa("link", "green")`
1. Spelling Checks &nbsp; &nbsp;`r fontawesome::fa("pen", "blue")`
1. Linters  &nbsp; &nbsp;`r fontawesome::fa("file-lines", "red")`
1. Manual Pages &nbsp; &nbsp;`r fontawesome::fa("book", "green")`
1. Style &nbsp; &nbsp;`r fontawesome::fa("scroll", "red")`
1. Test Coverage &nbsp; &nbsp;`r fontawesome::fa("car-burst", "green")`
1. Publishing a pkgdown site &nbsp; &nbsp;`r fontawesome::fa("wifi", "blue")`
