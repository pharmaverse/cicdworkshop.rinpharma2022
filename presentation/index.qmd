...
- **Issue 2:**  Common CI/CD for family of packages
:::
...
- How to ensure code stays up to date with deprecated functions or unforseen bugs get in?
- CI/CD for the win!
...
## Issue 2: Common CI/CD workflows to admiral extensions
