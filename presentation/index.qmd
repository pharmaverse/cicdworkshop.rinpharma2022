...
**Note:**: This workflow takes approximately 5-7 minutes to complete the first time.
It's faster the next time around as it caches dependencies.
...
::: footer
Advanced Usage: [File Location: r-cmd-check.yml](https://raw.githubusercontent.com/pharmaverse/admiralci/main/.github/workflows/r-cmd-check.yml)
:::
